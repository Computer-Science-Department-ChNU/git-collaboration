...
- **Що нового дізналася:** Налаштування безпечного SSH-з'єднання з GitHub за допомогою ключів, роботу з віддаленими репозиторіями через два джерела (`origin` та `upstream`), організацію гілкування та створення pull requests.
- **Враження:** Робота з інструментами контролю версій дуже зручна для командної розробки та відстеження змін у проєктах, хоча спочатку вимагає уважності до команд термінала й стандартів оформлення комітів (Conventional Commits).